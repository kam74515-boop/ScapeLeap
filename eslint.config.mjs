  ...
  // --- Custom Rule Overrides ---
  {
    rules: {
      ...
      'better-tailwindcss/no-unknown-classes': ['error', {
        ignore: [
          '^(flat-card|flat-button|flat-button-primary|flat-button-secondary|scape-container|eyebrow|display-title|section-title|text-balance|no-scrollbar|animate-float-soft|animate-pulse-ring)$',
        ],
      }],
    },
  },
